# Contributing to oxidized-compression
...
```bash
# 1. Fork and clone
git clone https://github.com/oxidized-mc/compression.git
cd compression
...
`oxidized-compression` is a library crate in the
...
Use `compression` as the scope for all changes to this crate.
